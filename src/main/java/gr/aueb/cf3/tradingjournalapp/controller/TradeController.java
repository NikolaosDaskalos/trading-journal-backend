...
public class TradeController {
    ...
    public ResponseEntity<TradeDTO> updateTrade(@PathVariable("tradeId") Long tradeId, @RequestBody @Valid TradeDTO dto, Principal principal) {
        try {
            dto.setId(tradeId);
            ...
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
        } catch (TradeUserCorrelationException e) {
            log.error(e.getMessage());
